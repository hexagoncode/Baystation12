/datum/map/discovery
	...
	usable_email_tlds = list("discovery.ec.scg", "discovery.fleet.mil", "freemail.net", "discovery.scg")

	allowed_spawns = list("Cryogenic Storage", "Cyborg Storage")
	default_spawn = "Cryogenic Storage"

	station_name  = "SEV Discovery"
	station_short = "Discovery"
	dock_name     = "TBD"
